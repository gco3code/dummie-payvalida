            ...
            var request = https.request(postObject, (res)=>{
              res.on('data',(d)=>{
                ...
                //if (response.statusCode == 200) {
                  var info = JSON.parse(process.stdout.write(d));                //{"status":"OK","mensajeError":null,"monto":6047.0,"cedula":"1098555777","descripcion":"ARTURO AMEREAGLETESORO 599-1","idTransaccion":1039,"email":"pagosbaloto@gmail.com"}
